      ...
      <div className="relative overflow-hidden rounded-[10px] bg-[#f5f0ee] shadow-saukhya-soft ring-1 ring-black/[0.04] transition-shadow duration-500 group-hover:shadow-saukhya-hover group-hover:ring-saukhya-gold/25">
        ...
        >
          <div className="relative aspect-[3/4] overflow-hidden">
            ...
            <motion.div
              ...
              className={cn(
                "pointer-events-none absolute inset-x-0 bottom-0 z-[1] bg-gradient-to-t to-transparent",
                showMetaBelow
                  ? "h-[58%] from-white/96 via-white/78"
                  : "h-[48%] from-black/65 via-black/22",
              )}
            />
          </div>
        </Link>
        ...
        {!showMetaBelow ? (
          ...
          <motion.div
            ...
            transition={{ duration: 0.3, ease: "easeOut" }}
            className="pointer-events-none absolute inset-x-0 bottom-0 z-10 px-3 pb-3 pt-10 md:px-4 md:pb-4"
          >
            ...
            <h3 className="mt-1.5 line-clamp-1 text-sm font-medium text-saukhya-text md:text-[15px]">
              {product.productName}
            </h3>
            <p className="mt-0.5 text-xs text-saukhya-muted">{product.subCategoryName}</p>
            <div className="mt-2 flex flex-wrap items-baseline gap-x-2 gap-y-0.5">
              ...
              <div className="border-t border-white/40 bg-[rgba(255,255,255,0.9)] shadow-[0_-16px_48px_rgba(31,26,28,0.1)] backdrop-blur-[2px]">
                <div className="px-3 py-3 md:px-3.5 md:py-3.5">
                  ...
                  >
                    ...
                    <p className="text-[10px] capitalize text-saukhya-muted">{fabric}</p>
                  </motion.div>
